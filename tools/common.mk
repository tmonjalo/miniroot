...
SET_EXTRA_CPPFLAGS = $(if $(TARGET_CPPFLAGS), EXTRA_CPPFLAGS='$(TARGET_CPPFLAGS)')
SET_CFLAGS = $(if $(TARGET_CFLAGS), CFLAGS='$(TARGET_CFLAGS)')
SET_EXTRA_CFLAGS = $(if $(TARGET_CFLAGS), EXTRA_CFLAGS='$(TARGET_CFLAGS)')
SET_CXXFLAGS = $(if $(TARGET_CXXFLAGS), CXXFLAGS='$(TARGET_CXXFLAGS)')
SET_EXTRA_CXXFLAGS = $(if $(TARGET_CXXFLAGS), EXTRA_CXXFLAGS='$(TARGET_CXXFLAGS)')
SET_LDFLAGS = $(if $(TARGET_LDFLAGS), LDFLAGS='$(TARGET_LDFLAGS)')
SET_EXTRA_LDFLAGS = $(if $(TARGET_LDFLAGS), EXTRA_LDFLAGS='$(TARGET_LDFLAGS)')
