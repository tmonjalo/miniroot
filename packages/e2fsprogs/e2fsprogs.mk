...
E2FSPROGS_SRC_AUTODIR := $(shell $(TOOLS_DIR)/get_src_dir.sh '$(SRC_DIR)' '$(E2FSPROGS_SRC)')
E2FSPROGS_BUILD_DIR := $(if $(E2FSPROGS_BUILD_INSIDE), $(E2FSPROGS_SRC_DIR), $(TARGET_BUILD_DIR)/$(notdir $(E2FSPROGS_SRC_DIR)))
...
$(E2FSPROGS_SRC_DIR) :
	@ $(TOOLS_DIR)/init_src.sh '$(E2FSPROGS_SRC)' '$(E2FSPROGS_DL_DIR)' '$@' '$(E2FSPROGS_PATCH_DIR)'
